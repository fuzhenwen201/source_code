...
int main(int argc, char **argv)
{
  ...
  size_t listener = socket(AF_INET, SOCK_STREAM, 0);
  struct event *_event = event_new(g.evbase, listener, EV_READ|EV_PERSIST, NULL, NULL);
  ...
  /* we don't call any curl_multi_socket*() function yet as we have no handles
     added! */
  //event_add(g.evbase,g.timer_event);
