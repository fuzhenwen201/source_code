...
extern stEpollEvent g_Events[MAX_EVENTS+1];

extern "C" int EventDel(int epollFd, stEpollEvent *ev);
extern "C" void SendData(int fd, int events, void *arg);
extern "C" void RecvData(int fd, int events, void *arg);
extern "C" void AcceptConn(int fd, int events, void *arg);
extern "C" int  InitSocket(int epollFd, short port, char* ip);
extern "C" int  EventAdd(int epollFd, int events, stEpollEvent *ev);
extern "C" void EventSet(stEpollEvent *ev, int fd, void (*call_back)(int, int, void*), void *arg);
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCSocketRcv(int vhDataSocket, char* vvpTcpData, int& vnpExpDataL, int vnRcvFlg);
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCSocketSnd(int vhDataSocket, char*  vvpTcpData, int& vnpExpDataL);
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCCreateSocket(int& vhpSocketId);
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCBind(unsigned int vnPortNum, char* vvpLocAddr, int& vhpSocketId);
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCSetSocketFlag(int vnSocketId, int vnSocketFlag);
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCClearSocketFlag(int vnSocketId, int vnSocketFlag); 
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCNBlockConnect(unsigned int vnPortNum, char* vvpRemAddr, int& vhpSocketId);
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCConnect(unsigned int vnPortNum, char* vvpRemAddr, int& vhpSocketId);
 ...
 **  *返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCListenPort(int nListenSocket, int nListenQueueLen);
 ...
 ** **返回值:   0/-1                                      **
 ** *******************************************************/
extern "C" int nCListenAccept(int nListenSocket, int& nAcceptSocket, struct sockaddr_in *pRemoteSocket);
#endif
