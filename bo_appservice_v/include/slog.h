...
#define LOG_DEBUG(format, ...)  slog_debug(PRE_STR format VAL_STR ,##__VA_ARGS__)
#define LOG_INFO(format, ...)  slog_info(PRE_STR format VAL_STR ,##__VA_ARGS__)
#define LOG_WARING(format, ...)  slog_warn(PRE_STR format VAL_STR ,##__VA_ARGS__)
#define LOG_ERR(format, ...)  slog_error(PRE_STR format VAL_STR ,##__VA_ARGS__)
