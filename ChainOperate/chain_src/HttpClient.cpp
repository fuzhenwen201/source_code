...
{  
	...
	{  
		//printf("HEADER_OUT:[%s]SIZE:[%lu]", pData,size);
	}  
	...
	{  
		//printf("DATA_OUT:[%s],SIZE:[%lu]", pData,size);
	}  
	return 0;  
#endif
...
HttpClient::HttpClient(): m_headerlist(nullptr),m_curl(nullptr)
{
...
void HttpClient::SetUserInfo(const char* userpwd)
{
