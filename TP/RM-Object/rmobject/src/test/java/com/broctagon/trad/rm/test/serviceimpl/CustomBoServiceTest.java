...
public class CustomBoServiceTest {

	Logger logger = Logger.getLogger(this.getClass());

	@Autowired
	private CustomizeBoService customBOService;
	...
	@Test
	public void customBoUpForOpen() {
		List<TradeModel> tradList = tradModelList();
		customBOService.writeCustomizedUpBoToRedis(tradList, tradList, tradList);
	}
	@Test
	public void customBoDwnForOpen() {
		List<TradeModel> tradList = tradModelList();
		customBOService.writeCustomizedDownBoToRedis(tradList, tradList, tradList);
	}
	@Test
	public void customBoUpForClose() {
		List<TradeModel> tradList = tradModelList();
		customBOService.writeCustomizedUpBoToRedis(tradList, tradList, tradList);
	}
	@Test
	public void customBoDwnForClose() {
		List<TradeModel> tradList = tradModelList();
		customBOService.writeCustomizedDownBoToRedis(tradList, tradList, tradList);
	}
}
