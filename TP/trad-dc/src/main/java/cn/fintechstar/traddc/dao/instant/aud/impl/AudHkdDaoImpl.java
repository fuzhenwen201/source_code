package cn.fintechstar.traddc.dao.instant.aud.impl;
...
@Repository
public class AudHkdDaoImpl implements cn.fintechstar.traddc.dao.instant.aud.AudHkdDao {

	@Autowired
	@Qualifier("audHkdTemplate")
	private JdbcTemplate jdbcTemplate;
	
	@Override
	public void saveAudHkd(InstantSignal instantSignal) {
		String sql = "INSERT INTO RAW_AUD_HKD(STATUS, BID, ASK, 'TIMESTAMP', TIME_FORMAT) VALUES(?, ?, ?, ?, ?)";
