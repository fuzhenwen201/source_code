package cn.fintechstar.traddc.dao.instant.sgd.impl;
...
@Repository
public class SgdHkdDaoImpl implements SgdHkdDao {
	
	@Autowired
	@Qualifier("sgdHkdTemplate")
	private JdbcTemplate jdbcTemplate;

	@Override
	public void saveSgdHkd(InstantSignal instantSignal) {
		String sql = "INSERT INTO RAW_SGD_HKD(STATUS, BID, ASK, 'TIMESTAMP', TIME_FORMAT) VALUES(?, ?, ?, ?, ?)";
