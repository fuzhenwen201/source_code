package cn.fintechstar.traddc.dao.instant.chf.impl;
...
@Repository
public class ChfHkdDaoImpl implements ChfHkdDao {

	@Autowired
	@Qualifier("chfHkdTemplate")
	private JdbcTemplate jdbcTemplate;
	
	@Override
	public void saveChfHkd(InstantSignal instantSignal) {
		String sql = "INSERT INTO RAW_CHF_HKD(STATUS, BID, ASK, 'TIMESTAMP', TIME_FORMAT) VALUES(?, ?, ?, ?, ?)";
