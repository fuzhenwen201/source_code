...
import cn.fintechstar.traddc.service.symbol.TryService;
...
public class TryListener {
	...
	@RabbitListener(queues="TRY_JPY.DC")
	public void tryJpyListener(Message message){
		...
		tryService.saveTryJpy(instantSignal);
