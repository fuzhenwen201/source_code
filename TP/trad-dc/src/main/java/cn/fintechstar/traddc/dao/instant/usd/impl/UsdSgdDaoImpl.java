...
@Repository
public class UsdSgdDaoImpl implements UsdSgdDao {
	
	@Autowired
	@Qualifier("usdSgdTemplate")
	private JdbcTemplate jdbcTemplate;
	
	@Override
	public void saveUsdSgd(InstantSignal instantSignal) {
		String sql = "INSERT INTO RAW_USD_SGD(STATUS, BID, ASK, 'TIMESTAMP', TIME_FORMAT) VALUES(?, ?, ?, ?, ?)";
