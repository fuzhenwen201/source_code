...
@Repository
public class SymbolButtDaoImpl implements SymboButtlDao {
	
	@Autowired
	@Qualifier("symbolButtTemplate")
	private JdbcTemplate jdbcTemplate;
	
	@Override
	public void saveSymbolButt(InstantSignal instantSignal) {
		String sql = "INSERT INTO RAW_SymbolBUTT(STATUS, BID, ASK, 'TIMESTAMP', TIME_FORMAT) VALUES(?, ?, ?, ?, ?)";
