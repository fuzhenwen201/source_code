...
public class DateUtilTest {
	...
	public void getDValueBetweenTwoTimestampTest(){
		int dValue = DateUtil.getDValueBetweenTwoTimestamp(1501740893000262L, 1501740902820262L, Granularity.S5);
		Assert.assertEquals(1, dValue);
		dValue = DateUtil.getDValueBetweenTwoTimestamp(1501740889500262L, 1501740999880262L, Granularity.S5);
		Assert.assertEquals(21, dValue);
		dValue = DateUtil.getDValueBetweenTwoTimestamp(1501740889500262L, 1501740999880262L, Granularity.M1);
		Assert.assertEquals(1, dValue);
	}
	...
	public void getPreMarketEndTimeTest(){
		//14:14:53
		String str = DateUtil.getPreMarketEndTime(1501740893000262L, 2, Granularity.S5);
		Assert.assertEquals("2017-08-03 14:14:40", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.S10);
		Assert.assertEquals("2017-08-03 14:14:20", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.S15);
		Assert.assertEquals("2017-08-03 14:14:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.S30);
		Assert.assertEquals("2017-08-03 14:13:00", str);		
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.M1);
		Assert.assertEquals("2017-08-03 14:11:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.M5);
		Assert.assertEquals("2017-08-03 13:55:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.M10);
		Assert.assertEquals("2017-08-03 13:40:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.M15);
		Assert.assertEquals("2017-08-03 13:15:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.M30);
		Assert.assertEquals("2017-08-03 12:30:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.H1);
		Assert.assertEquals("2017-08-03 11:00:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.H4);
		Assert.assertEquals("2017-08-03 00:00:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.H12);
		Assert.assertEquals("2017-08-02 00:00:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.D);
		Assert.assertEquals("2017-07-30 00:00:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.W);
		Assert.assertEquals("2017-07-10 00:00:00", str);
		str = DateUtil.getPreMarketEndTime(1501740893000262L, 3, Granularity.M);
