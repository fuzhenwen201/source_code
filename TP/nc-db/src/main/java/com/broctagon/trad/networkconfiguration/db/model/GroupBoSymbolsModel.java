...
public class GroupBoSymbolsModel {
	
	private Integer id;
	private Integer group_id;
	private String group_name;
	private Integer security_id;
	private Integer bo_caltype;
	...
	public Integer getBo_caltype() {
		return bo_caltype;
	}
	public void setBo_caltype(Integer bo_caltype) {
		this.bo_caltype = bo_caltype;
	}
