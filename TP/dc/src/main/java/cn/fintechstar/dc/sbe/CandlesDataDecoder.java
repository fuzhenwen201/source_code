...
public class CandlesDataDecoder
{
    ...
    public byte granularity(final int index)
    {
        if (index < 0 || index >= 32)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public int getGranularity(final byte[] dst, final int dstOffset)
    {
        final int length = 32;
        if (dstOffset < 0 || dstOffset > (dst.length - length))
        {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        //Token{signal=ENCODING, name='varStringEncoding', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=32, offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=BIG_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='ASCII', epoch='unix', timeUnit=nanosecond, semanticType='String'}}
        ...
        //Token{signal=ENCODING, name='varStringEncoding', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=32, offset=32, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=BIG_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='ASCII', epoch='unix', timeUnit=nanosecond, semanticType='String'}}
        builder.append("granularity=");
        for (int i = 0; i < granularityLength() && granularity(i) > 0; i++)
        {
            builder.append((char)granularity(i));
        }
        builder.append('|');
        //Token{signal=BEGIN_GROUP, name='candles', referencedName='null', description='null', id=3, version=0, deprecated=0, encodedLength=69, offset=64, componentTokenCount=42, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
