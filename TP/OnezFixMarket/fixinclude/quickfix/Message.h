...
public:
  ...
  { return FieldMap::hasGroup( num, group.field() ); }
    ...
    // add by savin
public:
    int FullQuoteRequestData(STQuoteRequest44 * pData) const;
    int FullQuoteRequestDataField(const FieldMap& fields, int space,STQuoteRequest44 * pData) const;

    int FullMarkDataResponeData( STQuoteRequest44 * pData) const ;
    int FullMarketReponseDataField(const FieldMap& fields, int space,STQuoteRequest44 * pData) const ;
