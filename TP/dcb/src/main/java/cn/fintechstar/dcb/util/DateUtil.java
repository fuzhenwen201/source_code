...
public class DateUtil {
	 ...
	 */
	public static String getMarketEndTimeStrByGranularity(long timestamp, String granularity) {
		LocalDateTime dateTime = getMarketEndTimeByGranularity(timestamp, granularity);
		return dateTimeFormatter.format(dateTime);
	}
	
	public static LocalDateTime getMarketEndTimeByGranularity(long timestamp, String granularity){
		LocalDateTime dateTime = getCurrentDateTime(timestamp);
		if(GranularityConstant.getSecondsMap().containsKey(granularity)){
			...
			return dateTime.with(TemporalAdjusters.next(DayOfWeek.MONDAY)).withHour(0).withMinute(0).withSecond(0);
	 ...
	 */
	public static String getMarketStartTimeStrByGranularity(long timestamp, String granularity) {
		LocalDateTime dateTime = getMarketStartTimeByGranularity(timestamp, granularity);
		return dateTimeFormatter.format(dateTime);
	}

	public static LocalDateTime getMarketStartTimeByGranularity(long timestamp, String granularity) {
		LocalDateTime dateTime = getCurrentDateTime(timestamp);
		if(GranularityConstant.getSecondsMap().containsKey(granularity)){
	 ...
	 * @param granularity 
	 */
	public static int getDValueBetweenTwoTimestamp(long previousTime, long currentTime, String granularity) {
	...
	public static String getPreMarketEndTime(long signalTime, int count, String granularity){
	...
	public static long getSecondsByGranularity(String granularity, long timestamp){
		if("M".equals(granularity)){
			...
			return GranularityConstant.getGranularityToSecondsMap().get(granularity);
		}
	}
